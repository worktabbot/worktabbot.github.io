export function workFixer(worksPull) {
    ...
    fixedWorks = fixedWorks.replace(/ Presented by Longines/ig, "");
    ...
    fixedWorks = fixedWorks.replace(/ presented by TwinSpires/ig, "");
    ...
    fixedWorks = fixedWorks.replace(/FanDuel TV /ig, "");
    ...
    fixedWorks = fixedWorks.replace(/ \(SAF\)/g, "");
